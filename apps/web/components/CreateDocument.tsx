    ...
    <main className="library-shell">
      ...
      <div className="library-grid">
        ...
        <section className="create-panel" aria-labelledby="create-title">
          <div className="create-heading"><span className="large-icon"><FilePlus2 /></span><div><span className="eyebrow">NEW REVIEW</span><h1 id="create-title">开始一次论文审阅</h1><p>粘贴英文论文，或导入通过安全校验的 .docx 文件。当前支持 500 至 5,000 个英文单词。</p></div></div>
